    ...
    return (
        ...
        >
            ...
            >
                ...
                <motion.div
                    className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20 flex items-end justify-center pb-6"
                >
                    <motion.span
                        initial={{ y: 20, opacity: 0 }}
                        animate={isHovered ? { y: 0, opacity: 1 } : { y: 20, opacity: 0 }}
                        className="text-white font-inter text-sm tracking-wide uppercase"
                    >
                        Preview Template
                    </motion.span>
                </motion.div>
